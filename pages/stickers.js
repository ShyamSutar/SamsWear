    ...
    <div>
      <section className="text-gray-600 body-font min-h-screen">
        <div className="container px-5 py-24 mx-auto">
          ...
          {Object.keys(products).length === 0 && <p className="mx-4">Sorry all the Stickers are currently out of stock, new stock coming soon.! Stay Tuned</p>}
            {Object.keys(products).map((item)=>{
              return <Link passHref={true} key={products[item]._id} href={`/product/${products[item].slug}`}>
              <div className="cursor-pointer p-6 px-8 shadow-lg m-5">
